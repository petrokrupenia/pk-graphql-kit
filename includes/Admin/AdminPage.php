...
class AdminPage {
    ...
    public function render(): void {
        ...
        <div class="wrap">
            ...
            <p style="color:#646970; margin-top:-8px;">Developer toolkit for headless WordPress — CPT, ACF, WPGraphQL
                schema in one place. <kbd><strong>v<?php echo esc_html( PK_GRAPHQL_KIT_VERSION ); ?></strong></kbd></p>

            <?php $this->render_section( 'Status', function () use ( $env, $env_color, $endpoint_url, $acf_active ): void { ?>
                <table class="widefat striped" style="max-width:600px;">
                    <tbody>
                    <tr>
                        <td style="width:200px;"><strong><?php esc_html_e( 'Environment', 'pkgraphqlkit' ); ?></strong>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo esc_url( $endpoint_url ); ?>"
                               target="_blank"><?php echo esc_html( $endpoint_url ); ?></a></td>
                    </tr>
                    <tr>
                        ...
                        <table class="widefat striped">
                            ...
                            <?php foreach ( $taxonomies as $taxonomy ) { ?>
                                <tr>
                                    ...
                                    <td><code><?php echo esc_html( $taxonomy->graphql_single_name ?? '—' ); ?></code>
                                    </td>
                                    <td><code><?php echo esc_html( $taxonomy->graphql_plural_name ?? '—' ); ?></code>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
                    ...
                    function () use ( $integrations ): void {
                        ...
                        foreach ( $integrations as $integration ) {
                            ...
                            <div style="margin-bottom:20px; padding:12px 16px; border:1px solid #c3c4c7; border-radius:4px; background:#fff;">
                                ...
                                <?php if ( ! empty( $types ) ) { ?>
                                    <p style="margin:8px 0 2px; font-size:12px; color:#646970; text-transform:uppercase; letter-spacing:.5px;">
                                        Types</p>
